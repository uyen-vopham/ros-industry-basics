...
class TurtleBotAruco(Node):
    def __init__(self):
        super().__init__('follow_aruco_node')
        ...
        #------------------------------------------------
        self.cli = self.create_client(GetObjectLocation, '/find_objects')
    ...
    def move_turtlebot(self, linear_velocity, angular_velocity):
        ...
        self.twist_ = Twist()
        self.twist_.linear.x = linear_velocity
        self.twist_.angular.z = angular_velocity
